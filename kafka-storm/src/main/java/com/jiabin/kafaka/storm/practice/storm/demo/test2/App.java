package com.jiabin.kafaka.storm.practice.storm.demo.test2;

import com.jiabin.kafaka.storm.practice.storm.demo.test.TestBolt;
import com.jiabin.kafaka.storm.practice.storm.demo.test.TestSpout;
...
public class App {
	...
	public static void main(String[] args)  {
		...
		builder.setBolt(test2_bolt, new com.jiabin.kafaka.storm.practice.storm.demo.test2.Test2Bolt(),1).setNumTasks(1).fieldsGrouping(test_bolt, new Fields("count"));
