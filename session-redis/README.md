...
```java
package com.jiabin.session.redis.practice.entity;
...
```java
package com.jiabin.session.redis.practice.repository;

import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.stereotype.Repository;

import com.jiabin.session.redis.practice.entity.User;
...
```java
package com.jiabin.session.redis.practice.controller;
...
import com.jiabin.session.redis.practice.entity.User;
import com.jiabin.session.redis.practice.repository.UserRepository;
...
```java
package com.jiabin.session.redis.practice.init;
...
```java
package com.jiabin.session.redis.practice.conf;
