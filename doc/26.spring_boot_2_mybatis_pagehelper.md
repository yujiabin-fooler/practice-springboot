...
<mapper namespace="com.jiabin.springboot.dao.practice.article.ArticleDao">

	<!-- 文章表结果集resultMap -->
    <resultMap type="com.jiabin.springboot.model.practice.entity.ArticleEntity" id="articleMap">
        <result property="id" column="id"/>
        <result property="title" column="title"/>
        <result property="content" column="content"/>
		<collection property="tagList" column="id" javaType="java.util.List" ofType="com.jiabin.springboot.model.practice.entity.ArticleTagEntity"
					select="com.jiabin.springboot.dao.practice.article.ArticleTagDao.queryTagsByArticleId">
...
<mapper namespace="com.jiabin.springboot.dao.practice.article.ArticleTagDao">

	<!-- 文章标签表结果集resultMap -->
    <resultMap type="com.jiabin.springboot.model.practice.entity.ArticleTagEntity" id="articleTagMap">
        <result property="id" column="id"/>
        <result property="tagName" column="tag_name"/>
    </resultMap>
