...
```xml
	<!-- 文章表结果集resultMap 2-->
	<resultMap type="com.jiabin.springboot.model.practice.entity.ArticleEntity" id="articleMap2">
		<result property="id" column="id"/>
		<result property="title" column="title"/>
		<result property="content" column="content"/>
		<collection property="tagList" javaType="java.util.List" ofType="com.jiabin.springboot.model.practice.entity.ArticleTagEntity" >
