 ...
 */
package com.jiabin.spring.seata.dubbo.saga.practice.provider;
 ...
 * Create At 2024/1/20
 */
@EnableDubbo(scanBasePackages = {"com.jiabin.spring.seata.dubbo.saga.practice.provider"})
@ComponentScan(basePackages = {"com.jiabin.spring.seata.dubbo.saga.practice.provider"})
