 ...
 */
package com.jiabin.spring.seata.dubbo.saga.practice.consumer;
...
@EnableDubbo(scanBasePackages = {"com.jiabin.springboot.mybatis.seata.practice.consumer"})
@ComponentScan(basePackages = {"com.jiabin.springboot.mybatis.seata.practice.consumer"})
