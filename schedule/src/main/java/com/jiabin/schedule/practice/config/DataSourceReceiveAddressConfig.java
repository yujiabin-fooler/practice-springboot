package com.jiabin.schedule.practice.config;
...
@Slf4j
@Configuration
@MapperScan(basePackages = {"com.jiabin.schedule.practice.dao.receiveaddress"},sqlSessionTemplateRef = "sqlSessionTemplateReceiveAddress")
