...
@EnableJpaRepositories(
        ...
        basePackages = {"com.jiabin.grpc.protocol.practice.grpcprotocol.jpa.repository.primary"})
public class PrimaryDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary(EntityManagerFactoryBuilder builder) {
        return builder.dataSource(dataSource())
                ...
                // 设置映射的实体类位置
                .packages("com.jiabin.grpc.protocol.practice.grpcprotocol.jpa.entity.primary")
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.jiabin.grpc.protocol.practice.grpcprotocol.jpa.repository.secondary"})
public class SecondaryDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactorySecondary(EntityManagerFactoryBuilder builder) {
        return builder.dataSource(dataSource())
                .properties(getVendorProperties())
                // 设置映射的实体类位置
                .packages("com.jiabin.grpc.protocol.practice.grpcprotocol.jpa.entity.secondary")
