...
```java
package com.jiabin.websocket.qrcode.practice.conf;
...
```java
package com.jiabin.websocket.qrcode.practice.controller;
...
import com.jiabin.websocket.qrcode.practice.conf.LoginWebSocket;
