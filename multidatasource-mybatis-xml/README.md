...
```java
@Configuration
@MapperScan(basePackages = "com.jiabin.grpc.protocol.practice.grpcprotocol.mybatis.mapper.primary", sqlSessionTemplateRef = "PrimarySqlSessionTemplate")
...
```java
@Configuration
@MapperScan(basePackages = "com.jiabin.grpc.protocol.practice.grpcprotocol.mybatis.mapper.secondary", sqlSessionTemplateRef = "SecondarySqlSessionTemplate")
