package com.jiabin.multidatasource.mybatis.xml.practice.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.jiabin.multidatasource.mybatis.xml.practice.mapper.secondary", sqlSessionTemplateRef = "SecondarySqlSessionTemplate")
