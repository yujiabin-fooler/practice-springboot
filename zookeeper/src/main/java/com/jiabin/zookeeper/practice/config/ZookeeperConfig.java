package com.jiabin.zookeeper.practice.config;
...
public class ZookeeperConfig {
    ...
    public ZooKeeper zkClient() {
        ...
        try {
            ...
            //After the connection is successful, the watcher will be called back to monitor.
            // This connection operation is asynchronous. After the new statement is executed,
            // the subsequent code will be called directly.
