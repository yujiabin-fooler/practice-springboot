package com.jiabin.multidatasource.mybatis.annotation.practice.config;
 ...
 **/
@Configuration
@MapperScan(basePackages = "com.jiabin.multidatasource.mybatis.annotation.practice.mapper.secondary",
